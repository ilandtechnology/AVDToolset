...
$process = Start-Process -FilePath "msiexec.exe" -ArgumentList "/i $(Join-Path $LocalWVDpath $packageFile) /qn ADDLOCAL=ALL ALLUSERS=1 REBOOT=ReallySuppress" -PassThru
