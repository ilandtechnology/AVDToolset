...
[CmdletBinding()] Param (
    ...
    [ValidateSet("Word","PowerPoint","Access","Excel","OneNote","Outlook","Publisher","Groove","Lync","Visio", "Project")]
...
function RemoveProductsFromConfigurationXML {
    ...
    [CmdletBinding()] Param (
        ...
        [ValidateSet("Word","PowerPoint","Access","Excel","OneNote","Outlook","Publisher","Groove","Lync")]
        [System.String[]]$Applications,
